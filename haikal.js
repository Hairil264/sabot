...
// Base © °Botsaid°Hw Mods : Copyan Dari Base Dika

› Create By © °Botsaid°͢
› Base Ori © °Botsaid°͢
› Copyan Base Dika Hisoka Morou

🌷 KALAU MAU RENAME TARO CREDITS GUA : © °Botsaid°*/
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC © °Botsaid°͢`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: m })} 
//=================================================//
try {
...
break
case 'jadikatalog': case 'Botsaidkatalog': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
let teks = `${q}`
{
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC © °Botsaid°͢`,"body": `Selamat ${salam} kak ${pushname}`,
...
break
case 'Botsaidpoll': case 'Botsaidjhon2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
{
"optionName": "SALAM BROTHER BY © °Botsaid°͢"
}
],
...
break
//=================================================//
case 'Botsaidtroli2': case 'Botsaidtrol': case 'jutrol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case 'Botsaidtroli3': case 'Botsaidtrol2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`© °Botsaid°APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
case 'Botsaiddaca': case 'Botsaiddaca':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`© °Botsaid°APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
case 'Botsaiddocu': case 'Botsaiddraknes':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'duc': case 'Botsaidslebew': case 'cumadocu': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'Botsaidvirtext1': case 'Botsaidzsu': case 'crashar1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °Botsaid°${iphone}` }, { quoted: doc })
}
}
break
case 'Botsaidvirtext2': case 'Botsaidtol': case 'crashar2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °Botsaid°${iphone1}` }, { quoted: doc })
}
}
break
case 'Botsaidvirtext3': case 'Botsaidmemek': case 'crashar3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °Botsaid°${iphone2}` }, { quoted: doc })
}
}
break
case 'Botsaidvirtext4': case 'Botsaidcontol': case 'crashar4': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °Botsaid°${iphone3}` }, { quoted: doc })
}
}
break
case 'Botsaidvirtext5': case 'Botsaidtextv': case 'crashar5': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °Botsaid°${iphone4}` }, { quoted: doc })
}
}
break
case 'Botsaidvirtext6': case 'Botsaidgas': case 'crashar6':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °Botsaid°${iphone5}` }, { quoted: doc })
}
}
break
case 'Botsaidvirtext7': case 'Botsaidvirtext': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °Botsaid°${iphone6}` }, { quoted: doc })
}
}
break
case 'Botsaidvirtext8': case 'Botsaidvirtext1': case 'crashar7':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °Botsaid°${buttonkal}` }, { quoted: doc })
}
}
break
case 'Botsaidvirtext9': case 'Botsaidvirtext2': case 'crashar8':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °Botsaid°${buttonvirus}` }, { quoted: doc })
}
}
break
case 'Botsaidvirtext10': case 'Botsaidvirtext3': case 'crashar9': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °Botsaid°${ngazap(prefix)}`}, { quoted: doc })
}
}
break
//=================================================//
case 'Botsaidbug1': case 'Botsaidcrash': case 'crashar10':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'Botsaidbug2': case 'Botsaidcrash1': case 'crashar11': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"mimetype": "image/jpeg",
"caption": `© © °Botsaid°͢${ngazap(prefix)}`,
...
{ quickReplyButton: { displayText: `HAIKAL`, id: `JAGOAN OM?`}},
 ...
 break
//=================================================//
case 'Botsaidbug3': case 'Botsaidcrash2': case 'crashar12': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"fileName": `© © °Botsaid°͢${ngazap(prefix)}`,
...
break
//=================================================//
case 'Botsaidbug4': case 'Botsaidcrash3': case 'crashar13':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'Botsaidbug5': case 'Botsaidcrash4': case 'crashar14': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case 'Botsaidbug6': case 'Botsaidcrash5': case 'crashar15':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'Botsaidbug7': case 'Botsaidcrash6': case 'crashar16':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"description": "Developer © °Botsaid°͢\nWhatsApp / Script Bot \n\nORDER ? CHAT AJA 👋",
"title": `© © °Botsaid°͢${ngazap(prefix)}`,
"previewType": "NONE",
"jpegThumbnail": messa.imageMessage,
}
...
break
//=================================================//
case 'Botsaidbug8': case 'Botsaidcrash7': case 'crashar17': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'buglokas': case 'Botsaidlokas2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME © °Botsaid°͢${ngazap(prefix)}`,
"groupName": `MY NAME © °Botsaid°͢${ngazap(prefix)}`,
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© © °Botsaid°͢${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© © °Botsaid°͢${ngazap(prefix)}`,
...
"title": `© © °Botsaid°͢${ngazap(prefix)}`,
"description": `© © °Botsaid°͢`,
"currencyCode": "IDR",
"footerText": `© © °Botsaid°͢`,
"priceAmount1000": "10000000",
"productImageCount": 1,
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© © °Botsaid°WE ARE NOT MASTOD`,
...
break
case '🌷': case 'crashmek': case 'ampunsuhu': case 'ahyangbetul': case 'okemek': case 'Botsaidnih': case 'crashar18': case 'mexdemam': case 'Botsaid1': case 'Botsaid2': case 'Botsaid3': case 'Botsaid4': case 'Botsaid5': case 'Botsaid6': case 'Botsaid7': case 'Botsaid8': case 'Botsaid9': case 'Botsaid10': case 'Botsaid11': case 'Botsaid12': case 'Botsaid13': case 'Botsaid14': case 'Botsaid15': case 'Botsaid16': case 'Botsaid17': case 'Botsaid18': case 'Botsaid19': case 'Botsaid20': case 'Botsaid21': case 'Botsaid22': case 'Botsaid23': case 'Botsaid24': case 'Botsaid25': case 'Botsaid26': case 'Botsaid27': case 'Botsaid28':
case 'Botsaid29':
case 'Botsaid30':
case 'Botsaid31':
case 'Botsaid32':
...
break
//=================================================//
case 'Botsaidstik': case 'Botsaidkangbug': case 'buttonkematian': case 'crashar19': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'Botsaidbugie': case 'Botsaidkangbug1': case 'crashar20': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (!text) throw `*Type some text*\n\nExample : ${prefix + command} Botsaidmods`
...
break
//=================================================//
case 'Botsaidbutton': case 'Botsaidkangbuttton': case 'testbutton': case 'inibutton': 
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, buttonMessage)
 ...
 break
//=================================================//
case 'Botsaidtag': case 'Botsaidbar':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `© °Botsaid°${ngazap(prefix)}.BIN`, title: `© °Botsaid°${ngazap(prefix)}.BIN` }, { quoted: doc })
}
}
break
//=================================================//
case 'Botsaidtod': case 'Botsaidewe': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
for (let i = 0; i < jumlah; i++) {
 const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `© © °Botsaid°͢${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:© °Botsaid°͢\nitem1.TEL:+6285788734756\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}
...
break
//=================================================//
case 'Botsaidbokep': case 'Botsaidngentod': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, anuala, `© °Botsaid°͢${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © °Botsaid°͢, 7, 7, 2005, Putri, 16, 11, 2004`
...
case 'artinama': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © °Botsaid°Gans`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © °Botsaid°͢, 7, 7, 2005`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © °Botsaid°͢|Putri`
...
case 'fengshui': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © °Botsaid°͢, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
case 'Botsaidsound98':
case 'Botsaidsound99':
case 'Botsaidsound100':
case 'Botsaidsound101':
case 'Botsaidsound102':
case 'Botsaidsound103':
case 'Botsaidsound104':
case 'Botsaidsound105':
case 'Botsaidsound106':
case 'Botsaidsound107':
case 'Botsaidsound108':
case 'Botsaidsound109':
case 'Botsaidsound110':
case 'Botsaidsound111':
case 'Botsaidsound112':
case 'Botsaidsound113':
case 'Botsaidsound114':
case 'Botsaidsound115':
case 'Botsaidsound116':
case 'Botsaidsound117':
case 'Botsaidsound118':
case 'Botsaidsound119':
case 'Botsaidsound120':
case 'Botsaidsound121':
case 'Botsaidsound122':
case 'Botsaidsound123':
case 'Botsaidsound124':
case 'Botsaidsound125':
case 'Botsaidsound126':
case 'Botsaidsound127':
case 'Botsaidsound128':
case 'Botsaidsound129':
case 'Botsaidsound130':
case 'Botsaidsound131':
case 'Botsaidsound132':
case 'Botsaidsound133':
case 'Botsaidsound134':
case 'Botsaidsound135':
case 'Botsaidsound136':
case 'Botsaidsound137':
case 'Botsaidsound138':
case 'Botsaidsound139':
case 'Botsaidsound140':
case 'Botsaidsound141':
case 'Botsaidsound142':
case 'Botsaidsound143':
case 'Botsaidsound144':
case 'Botsaidsound145':
case 'Botsaidsound146':
case 'Botsaidsound147':
case 'Botsaidsound148':
case 'Botsaidsound149':
case 'Botsaidsound150':
case 'Botsaidsound151':
case 'Botsaidsound152':
case 'Botsaidsound153':
case 'Botsaidsound154':
case 'Botsaidsound155':
case 'Botsaidsound156':
case 'Botsaidsound157':
case 'Botsaidsound158':
case 'Botsaidsound159':
case 'Botsaidsound160':
case 'Botsaidsound161':
 if (isBan) throw sticBanLu(from)
...
break
case 'Botsaidghoib': case 'welcome': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
┗━━⊱
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
© °Botsaid°͢`, contextInfo:{"externalAdReply": {"title": `SC °Botsaid°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
[ 🇲🇨 𝐀𝐤𝐮 𝐀𝐝𝐚𝐥𝐚𝐡 𝐁𝐨𝐭 𝐖𝐚𝐫 𝐃𝐚𝐫𝐢 𝐈𝐧𝐝𝐨𝐧𝐞𝐬𝐢𝐚 ]
...
┏━━⊱[ SPECIAL ]
┣❏𝐚𝐟𝐤 { 𝐤𝐚𝐬𝐢𝐡 𝐫𝐞𝐚𝐜𝐭𝐢𝐨𝐧 }
┣❏𝐁𝐨𝐭𝐬𝐚𝐢𝐝𝐠𝐡𝐨𝐢𝐛笑  [ 𝐨𝐧 / 𝐨𝐟𝐟 ]
┣❏𝐁𝐨𝐭𝐬𝐚𝐢𝐝𝐣𝐚𝐠𝐨𝐚𝐧笑 [ 𝐫𝐞𝐩𝐥𝐲 𝐭𝐚𝐫𝐠𝐞𝐭 ]
┣❏𝐁𝐨𝐭𝐬𝐚𝐢𝐝𝐬𝐚𝐧𝐠𝐞笑  [ 𝐇𝐚𝐫𝐮𝐬 𝐌𝐞𝐧𝐣𝐚𝐝𝐢 𝐀𝐝𝐦𝐢𝐧 ]
┣❏𝐁𝐮𝐠𝐭𝐢𝐤𝐭𝐨𝐤笑 [ 𝐋𝐢𝐧𝐤 ] - 𝐁𝐮𝐠 𝐒𝐰
┗━━⊱[°𝐁𝐨𝐭𝐬𝐚𝐢𝐝°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱[ 𝐓𝐀𝐑𝐆𝐄𝐓 ]
┣❏🔥 𝟔𝟐𝟖𝟏𝐱𝐱𝐱|𝟓|𝟓𝐬 
┣❏𝐜𝐫𝐚𝐬𝐡𝐦𝐞𝐱笑 𝟔𝟐𝟖𝟏𝐱𝐱𝐱|𝟓|𝟓𝐬
┣❏𝐁𝐨𝐭𝐬𝐚𝐢𝐝𝐬𝐤𝐮𝐲笑 𝟔𝟐𝟖𝟏𝐱𝐱𝐱
┣❏𝐁𝐨𝐭𝐬𝐚𝐢𝐝𝐬𝐚𝐧𝐭𝐞𝐭笑 𝟔𝟐𝟖𝟏𝐱𝐱𝐱@𝐬.𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩.𝐧𝐞𝐭|𝟏𝟎|𝟏𝟎𝐬
┣❏𝐜𝐚𝐭𝐚𝐥𝐨𝐠𝐩𝐜笑 𝟔𝟐𝟖𝟏𝐱𝐱𝐱@𝐬.𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩.𝐧𝐞𝐭|𝟏𝟎|𝟏𝟎𝐬
┗━━⊱[°𝐁𝐨𝐭𝐬𝐚𝐢𝐝°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
𝐊𝐞𝐭𝐢𝐤 > 𝐦.𝐜𝐡𝐚𝐭 ( 𝐝𝐢 𝐠𝐫𝐨𝐮𝐩 𝐝𝐮𝐥𝐮 )
┏━━⊱[ 𝐆𝐑𝐎𝐔𝐁 ]
┣❏𝐠𝐚𝐬𝐛𝐨𝐭𝐬𝐚𝐢𝐝笑 𝟏𝟐𝟑𝟕𝟖𝟗𝟏𝐱𝐱𝐱𝐱
┣❏𝐛𝐨𝐭𝐬𝐚𝐢𝐝𝐬𝐚𝐧𝐭𝐞𝐭𝐠𝐜笑  𝟏𝟐𝟑𝟕𝟖𝟗𝟏𝐱𝐱𝐱𝐱@𝐠.𝐮𝐬|𝟏𝟎|𝟏𝟎𝐬
┣❏𝐜𝐚𝐭𝐚𝐥𝐨𝐠𝐠𝐜笑 𝟏𝟐𝟑𝟕𝟖𝟗𝟏𝐱𝐱𝐱𝐱@𝐠.𝐮𝐬|𝟏𝟎|𝟏𝟎𝐬
┗━━⊱[°𝐁𝐨𝐭𝐬𝐚𝐢𝐝°]
┏━━⊱[ 𝐁𝐔𝐆 ]
┣❏💀 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
┣❏👽 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱[ JADI BUG VIP ]
┣❏𝐣𝐚𝐝𝐢𝐤𝐚𝐭𝐚𝐥𝐨𝐠笑 [𝐫𝐞𝐩𝐥𝐲 𝐬𝐭𝐢𝐜𝐤𝐞𝐫] 𝐣𝐮𝐦𝐥𝐚𝐡
┣❏𝐣𝐚𝐝𝐢𝐣𝐚𝐠𝐨笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐩𝐨𝐥𝐥𝐢𝐧𝐠笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐭𝐫𝐨𝐥𝐢笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐥𝐨𝐤𝐚𝐬笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐝𝐚𝐫𝐤𝐧𝐞𝐬笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐝𝐨𝐜𝐮笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐛𝐮𝐠𝐢𝐧𝐯𝐢𝐭𝐞笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐛𝐮𝐠𝐩𝐚𝐲𝐦𝐞𝐧𝐭笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐛𝐮𝐠𝐬𝐰笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐛𝐮𝐠𝐛𝐨𝐤𝐞𝐩笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐛𝐮𝐠𝐛𝐮𝐭𝐭𝐨𝐧笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐯𝐢𝐫𝐭𝐞𝐱𝟏笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐯𝐢𝐫𝐭𝐞𝐱𝟐笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐯𝐢𝐫𝐭𝐞𝐱𝟑笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐯𝐢𝐫𝐭𝐞𝐱𝟒笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐯𝐢𝐫𝐭𝐞𝐱𝟓笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐯𝐢𝐫𝐭𝐞𝐱𝟔笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐯𝐢𝐫𝐭𝐞𝐱𝟕笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐯𝐢𝐫𝐭𝐞𝐱𝟖笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐯𝐢𝐫𝐭𝐞𝐱𝟗笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐯𝐢𝐫𝐭𝐞𝐱𝟏𝟎笑 [𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐭𝐞𝐱𝐭 𝐧𝐲𝐚]
┣❏𝐣𝐚𝐝𝐢𝐛𝐮𝐠1笑 [𝐑𝐞𝐩𝐥𝐲 𝐯𝐢𝐝𝐞𝐨 𝐉𝐚𝐝𝐢 𝐁𝐮𝐠 𝐀𝐮𝐝𝐢𝐨]
┣❏𝐣𝐚𝐝𝐢𝐛𝐮𝐠2笑 [𝐑𝐞𝐩𝐥𝐲 𝐯𝐢𝐝𝐞𝐨 𝐉𝐚𝐝𝐢 𝐁𝐮𝐠 𝐦𝐩𝟑]
┣❏𝐣𝐚𝐝𝐢𝐛𝐮𝐠3笑 [𝐑𝐞𝐩𝐥𝐲 𝐚𝐮𝐝𝐢𝐨 𝐉𝐚𝐝𝐢 𝐁𝐮𝐠 𝐯𝐧]
┣❏𝐣𝐚𝐝𝐢𝐛𝐮𝐠4笑 [𝐫𝐞𝐩𝐥𝐲 𝐬𝐭𝐢𝐜𝐤𝐞𝐫 𝐣𝐚𝐝𝐢 𝐛𝐮𝐠 𝐠𝐚𝐦𝐛𝐚𝐫]
┣❏𝐣𝐚𝐝𝐢𝐛𝐮𝐠5笑 [𝐑𝐞𝐩𝐥𝐲 𝐠𝐚𝐦𝐛𝐚𝐫 𝐣𝐚𝐝𝐢 𝐛𝐮𝐠 𝐨𝐧𝐜𝐞] 
┗━━⊱[°𝐁𝐨𝐭𝐬𝐚𝐢𝐝°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱[ VIRTEXT ]
┣❏𝐛𝐨𝐭𝐬𝐚𝐢𝐝𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟏笑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
┣❏𝐛𝐨𝐭𝐬𝐚𝐢𝐝𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟐笑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
┣❏𝐛𝐨𝐭𝐬𝐚𝐢𝐝𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟑笑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
┣❏𝐛𝐨𝐭𝐬𝐚𝐢𝐝𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟒笑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
┣❏𝐛𝐨𝐭𝐬𝐚𝐢𝐝𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟓笑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
┣❏𝐛𝐨𝐭𝐬𝐚𝐢𝐝𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟔笑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
┣❏𝐛𝐨𝐭𝐬𝐚𝐢𝐝𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟔笑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
┣❏𝐛𝐨𝐭𝐬𝐚𝐢𝐝𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟖笑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
┣❏𝐛𝐨𝐭𝐬𝐚𝐢𝐝𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟗笑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
┣❏𝐛𝐨𝐭𝐬𝐚𝐢𝐝𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝟏𝟎笑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
┗━━⊱[°𝐁𝐨𝐭𝐬𝐚𝐢𝐝°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
...