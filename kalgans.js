...
🌷 KALAU MAU RENAME TARO CREDITS GUA : 𝐁𝐨𝐭𝐬𝐚𝐢𝐝☆ */
...
browser: ['𝐁𝐨𝐭𝐬𝐚𝐢𝐝 Multi Device','Safari','1.0.0'],
auth: state})
//=================================================//
...
let buttons = [
{buttonId: `𝐁𝐨𝐭𝐬𝐚𝐢𝐝☆`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
